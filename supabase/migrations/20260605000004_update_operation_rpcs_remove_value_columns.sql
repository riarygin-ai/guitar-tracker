-- Update all operation RPCs to remove cash_value and trade_value columns
-- from deal_items INSERTs (those columns were dropped in migration 20260605000003).
...
BEGIN
  ...
  -- 8. Re-insert incoming deal_items
  FOR v_item IN SELECT * FROM jsonb_array_elements(p_incoming_items) LOOP
    INSERT INTO deal_items (deal_id, item_id, direction, total_value)
    VALUES (
      p_deal_id,
