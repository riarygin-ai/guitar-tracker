// Insights Engine v1.3 — orchestrator. Runs the Findings Selector rule set
...
//   STRONG_DEAL_IN_TO_DEAL_OUT_JOURNEY      (new in v1.3)
...
// check — not a general deduplication framework. The acquisition-method and
// channel-journey rules have no relationship to either — they compare
// Purchase vs. Trade and Deal In vs. Deal Out channel, both orthogonal
// dimensions to acquisition value band / category.
...
export const INSIGHTS_ENGINE_VERSION = '1.3';
export const FINDINGS_SELECTOR_VERSION = '1.3';
