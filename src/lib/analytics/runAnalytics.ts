...
//
// v1.3: new runs call build_analytics_snapshot_v1_3 (Channel Analytics
// module 2 — Deal Out Channel Performance — see
// analytics/SEMANTIC_CONTRACT.md). v1.0/v1.1/v1.2's builder functions and
// every previously stored v1.0/v1.1/v1.2 analytics_runs.snapshot row are
// untouched and remain readable — this is a forward version bump, not a
// rewrite of history.
export const ANALYTICS_VERSION = '1.3';
export const EVIDENCE_SCOPE = 'shared_business_population';
const SNAPSHOT_SCHEMA_VERSION = '1.3';
const ANALYTICS_DEFINITION_VERSION = '1.3';
const SNAPSHOT_BUILDER_RPC = 'build_analytics_snapshot_v1_3';
