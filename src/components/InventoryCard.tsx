...
export default function InventoryCard({ item, brandName, backQuery, mainPhotoUrl, subtypeName, totalExpenses = 0 }: InventoryCardProps) {
  ...
  return (
    <div className="flex flex-col rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-slate-700 dark:bg-slate-800">
      <Link href={itemHref} className="block p-4 pb-2">
      ...
      {/* Bottom row: View Chain button pinned to bottom-right */}
