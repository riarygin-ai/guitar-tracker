...
export default function BuyOperationForm() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const cfDescription = description ? `Purchase: ${description}` : 'Purchase';
  ...
  <div className="space-y-6">
    ...
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
      <div className="mb-4">
        ...
        <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Search for an existing item or create a new one for this purchase.</p>
      </div>
        ...
        <div className="space-y-4 rounded-3xl border border-slate-200 bg-slate-50 p-5 dark:border-slate-600 dark:bg-slate-700">
          ...
          <div className="grid gap-3">
            <div className="rounded-2xl bg-white p-4 dark:bg-slate-600">
              ...
              <p className="mt-2 text-sm font-medium text-slate-900 dark:text-slate-100">{buyValueIn > 0 ? fmt(buyValueIn) : '—'}</p>
            </div>
            <div className="rounded-2xl bg-white p-4 dark:bg-slate-600">
              <p className="text-xs uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400">Estimated Sold</p>
              <p className="mt-2 text-sm font-medium text-slate-900 dark:text-slate-100">{fmt(estimatedSold)}</p>
            </div>
            <div className="rounded-2xl bg-white p-4 dark:bg-slate-600">
              <p className="text-xs uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400">Potential Reward</p>
